...
--               /home/ug_lab/finn/notebooks/pls5/output/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_ConvolutionInputGenerator_rtl_6_0/finn_design_ConvolutionInputGenerator_rtl_6_0_sim_netlist.vhdl
-- Design      : finn_design_ConvolutionInputGenerator_rtl_6_0
...
entity finn_design_ConvolutionInputGenerator_rtl_6_0_swg_controller is
  port (
    addr_incr0 : out STD_LOGIC;
    S : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \First_elem_next_window_reg[11]\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
    \First_elem_next_window_reg[6]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \State_reg[2]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \Current_elem_reg[11]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \Window_buffer_read_addr_reg_reg[11]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    Fetching_done_reg : out STD_LOGIC;
    D : out STD_LOGIC_VECTOR ( 3 downto 0 );
    Fetching_done_reg_0 : out STD_LOGIC_VECTOR ( 10 downto 0 );
    \State_reg[0]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \Current_elem_reg[14]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \Newest_buffered_elem_reg[15]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \Window_buffer_read_addr_reg_reg[12]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    ...
    \Window_buffer_read_addr_reg1_carry__2\ : in STD_LOGIC_VECTOR ( 9 downto 0 );
    ...
    \Current_elem_reg[15]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    DI : in STD_LOGIC_VECTOR ( 0 to 0 );
    \Window_buffer_read_addr_reg_reg[5]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \Window_buffer_read_addr_reg_reg[9]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \Window_buffer_read_addr_reg_reg[12]_0\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
    \Window_buffer_read_addr_reg_reg[9]_0\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute ORIG_REF_NAME of finn_design_ConvolutionInputGenerator_rtl_6_0_swg_controller : entity is "swg_controller";
end finn_design_ConvolutionInputGenerator_rtl_6_0_swg_controller;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_6_0_swg_controller is
  ...
  signal Counter_loop_simd0 : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \Counter_loop_simd[7]_i_1_n_0\ : STD_LOGIC;
  signal \Counter_loop_simd[7]_i_4_n_0\ : STD_LOGIC;
  signal \Counter_loop_simd[7]_i_5_n_0\ : STD_LOGIC;
  signal Counter_loop_simd_reg : STD_LOGIC_VECTOR ( 7 to 7 );
  ...
  signal \Counter_loop_simd_reg_n_0_[6]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \Counter_loop_h[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Counter_loop_h[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Counter_loop_h[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Counter_loop_h[4]_i_3\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \Counter_loop_simd[7]_i_4\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Counter_loop_w[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Counter_loop_w[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Counter_loop_w[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Counter_loop_w[4]_i_3\ : label is "soft_lutpair1";
...
\Counter_loop_simd[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\Counter_loop_simd[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000008FFFFFFFF"
    )
        port map (
      I0 => Counter_loop_simd_reg(7),
      I1 => \State_reg_n_0_[0]\,
      I2 => \State_reg_n_0_[1]\,
      I3 => \^addr_incr0\,
...
\Counter_loop_simd[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\Counter_loop_simd[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E1"
    )
        port map (
...
\Counter_loop_simd[7]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\Counter_loop_simd[7]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\Counter_loop_simd_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\Counter_loop_simd_reg[6]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '1'
    )
        port map (
...
\Counter_loop_simd_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\Current_elem0_carry__1_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\Current_elem0_carry__1_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6A6A6A956A956A95"
    )
        port map (
...
\Current_elem0_carry__1_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"936C6C93"
    )
        port map (
...
\Current_elem0_carry__1_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Current_elem0_carry__1_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Current_elem0_carry__2_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4B"
    )
        port map (
...
\Current_elem0_carry__2_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"07F8F807"
    )
        port map (
...
\First_elem_next_window0_carry__1_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Out[2]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EEFE"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__1_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"93"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__1_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__1_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6A6A6A956A956A95"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__1_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"936C6C93"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__1_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__1_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__2_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"07F8F807"
    )
        port map (
...
\Window_buffer_read_addr_reg[9]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\Window_buffer_read_addr_reg[9]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0D02"
    )
        port map (
...
\Window_buffer_read_addr_reg_reg[12]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(2 downto 0) => Fetching_done_reg_0(10 downto 8),
      S(3) => '0',
...
\Window_buffer_read_addr_reg_reg[5]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => DI(0),
      DI(1) => \Window_buffer_read_addr_reg[5]_i_3_n_0\,
      DI(0) => '0',
      O(3 downto 0) => Fetching_done_reg_0(3 downto 0),
      S(3) => \Window_buffer_read_addr_reg[5]_i_4_n_0\,
      S(2) => \Window_buffer_read_addr_reg_reg[5]\(1),
      S(1) => \Window_buffer_read_addr_reg[5]_i_6_n_0\,
...
\Window_buffer_read_addr_reg_reg[9]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => DI(0),
      DI(0) => \Window_buffer_read_addr_reg[9]_i_4_n_0\,
      O(3 downto 0) => Fetching_done_reg_0(7 downto 4),
      S(3) => \Window_buffer_read_addr_reg_reg[9]\(1),
      S(2) => \Window_buffer_read_addr_reg[9]_i_6_n_0\,
      S(1) => \Window_buffer_read_addr_reg_reg[9]\(0),
      S(0) => \Window_buffer_read_addr_reg[9]_i_8_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_ConvolutionInputGenerator_rtl_6_0_swg_cyclic_buffer_addressable is
  port (
    ...
    Newest_buffered_elem_reg_11_sp_1 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_ConvolutionInputGenerator_rtl_6_0_swg_cyclic_buffer_addressable : entity is "swg_cyclic_buffer_addressable";
end finn_design_ConvolutionInputGenerator_rtl_6_0_swg_cyclic_buffer_addressable;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_6_0_swg_cyclic_buffer_addressable is
  signal Newest_buffered_elem_reg_11_sn_1 : STD_LOGIC;
  ...
  signal Ram_reg_1600_1663_0_2_i_3_n_0 : STD_LOGIC;
  ...
  attribute RTL_RAM_BITS of Ram_reg_0_63_0_2 : label is 10296;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of Ram_reg_0_63_0_2_i_2 : label is "soft_lutpair8";
  attribute METHODOLOGY_DRC_VIOS of Ram_reg_1024_1087_0_2 : label is "";
  attribute RTL_RAM_BITS of Ram_reg_1024_1087_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1088_1151_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1152_1215_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1216_1279_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1280_1343_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_128_191_0_2 : label is 10296;
  ...
  attribute SOFT_HLUTNM of Ram_reg_128_191_0_2_i_2 : label is "soft_lutpair10";
  attribute METHODOLOGY_DRC_VIOS of Ram_reg_1344_1407_0_2 : label is "";
  attribute RTL_RAM_BITS of Ram_reg_1344_1407_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1408_1471_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1472_1535_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1536_1599_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1600_1663_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1664_1727_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1728_1791_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1792_1855_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1856_1919_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1920_1983_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_192_255_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1984_2047_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2048_2111_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2112_2175_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2176_2239_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2240_2303_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2304_2367_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2368_2431_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2432_2495_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2496_2559_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2560_2623_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_256_319_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2624_2687_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2688_2751_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2752_2815_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2816_2879_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2880_2943_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_2944_3007_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_3008_3071_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_3072_3135_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_3136_3199_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_3200_3263_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_320_383_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_3264_3327_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_3328_3391_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_3392_3455_0_2 : label is 10296;
  attribute RTL_RAM_NAME of Ram_reg_3392_3455_0_2 : label is "inst/impl/window_buffer_inst/Ram_reg_3392_3455_0_2";
  attribute RTL_RAM_TYPE of Ram_reg_3392_3455_0_2 : label is "RAM_SDP";
  attribute ram_addr_begin of Ram_reg_3392_3455_0_2 : label is 3392;
  attribute ram_addr_end of Ram_reg_3392_3455_0_2 : label is 3431;
  ...
  attribute RTL_RAM_BITS of Ram_reg_384_447_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_448_511_0_2 : label is 10296;
  ...
  attribute SOFT_HLUTNM of Ram_reg_448_511_0_2_i_2 : label is "soft_lutpair8";
  attribute METHODOLOGY_DRC_VIOS of Ram_reg_512_575_0_2 : label is "";
  attribute RTL_RAM_BITS of Ram_reg_512_575_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_576_639_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_640_703_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_64_127_0_2 : label is 10296;
  ...
  attribute SOFT_HLUTNM of Ram_reg_64_127_0_2_i_2 : label is "soft_lutpair9";
  attribute METHODOLOGY_DRC_VIOS of Ram_reg_704_767_0_2 : label is "";
  attribute RTL_RAM_BITS of Ram_reg_704_767_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_768_831_0_2 : label is 10296;
  ...
  attribute RTL_RAM_BITS of Ram_reg_832_895_0_2 : label is 10296;
  ...
  attribute SOFT_HLUTNM of Ram_reg_832_895_0_2_i_2 : label is "soft_lutpair10";
  attribute METHODOLOGY_DRC_VIOS of Ram_reg_896_959_0_2 : label is "";
  attribute RTL_RAM_BITS of Ram_reg_896_959_0_2 : label is 10296;
  ...
  attribute SOFT_HLUTNM of Ram_reg_896_959_0_2_i_2 : label is "soft_lutpair9";
  attribute METHODOLOGY_DRC_VIOS of Ram_reg_960_1023_0_2 : label is "";
  attribute RTL_RAM_BITS of Ram_reg_960_1023_0_2 : label is 10296;
...
begin
  Newest_buffered_elem_reg_11_sp_1 <= Newest_buffered_elem_reg_11_sn_1;
...
Ram_reg_1600_1663_0_2_i_2: unisim.vcomponents.LUT6
    generic map(
...
Ram_reg_1600_1663_0_2_i_3: unisim.vcomponents.LUT6
    generic map(
...
in0_V_TREADY_INST_0_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7FFF"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6_impl is
  port (
    out_V_TDATA : out STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6_impl : entity is "ConvolutionInputGenerator_rtl_6_impl";
end finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6_impl;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6_impl is
  ...
  signal \First_elem_next_window0_carry__2_n_1\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__2_n_2\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__2_n_3\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__2_n_4\ : STD_LOGIC;
  ...
  signal \Position_in_window[9]_i_1_n_0\ : STD_LOGIC;
  signal \Position_in_window[9]_i_4_n_0\ : STD_LOGIC;
  signal \Position_in_window[9]_i_5_n_0\ : STD_LOGIC;
  signal Position_in_window_reg : STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  signal \Window_buffer_read_addr_reg1_carry__1_i_1_n_0\ : STD_LOGIC;
  ...
  signal \Window_buffer_read_addr_reg1_carry__2_n_3\ : STD_LOGIC;
  signal \Window_buffer_read_addr_reg1_carry__2_n_6\ : STD_LOGIC;
  ...
  signal \NLW_First_elem_next_window0_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_Newest_buffered_elem_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_Window_buffer_read_addr_reg1_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_Window_buffer_read_addr_reg1_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Current_elem[15]_i_13\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Current_elem[15]_i_4\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \Newest_buffered_elem[12]_i_4\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \Position_in_window[0]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Position_in_window[1]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \Position_in_window[2]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Position_in_window[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Position_in_window[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Position_in_window[6]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Position_in_window[7]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Position_in_window[8]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \Position_in_window[9]_i_3\ : label is "soft_lutpair15";
  attribute ADDER_THRESHOLD of Window_buffer_read_addr_reg1_carry : label is 35;
  attribute ADDER_THRESHOLD of \Window_buffer_read_addr_reg1_carry__0\ : label is 35;
  attribute ADDER_THRESHOLD of \Window_buffer_read_addr_reg1_carry__1\ : label is 35;
  attribute ADDER_THRESHOLD of \Window_buffer_read_addr_reg1_carry__2\ : label is 35;
  ...
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[10]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[11]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[11]_i_6\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[3]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[4]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[5]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[7]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[8]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[9]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of Write_cmd_i_1 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of in0_V_TREADY_INST_0 : label is "soft_lutpair16";
...
\Current_elem0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(2) => controller_inst_n_52,
      S(1) => controller_inst_n_53,
...
\Current_elem0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \Current_elem0_carry__1_i_1_n_0\,
      DI(2) => controller_inst_n_48,
      DI(1) => controller_inst_n_49,
      DI(0) => addr_incr0,
      O(3 downto 0) => data0(11 downto 8),
      S(3) => controller_inst_n_12,
      S(2) => controller_inst_n_13,
      S(1) => controller_inst_n_14,
      S(0) => controller_inst_n_15
    );
...
\Current_elem0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => Current_elem(13),
      DI(1) => \Current_elem0_carry__2_i_1_n_0\,
      DI(0) => \Current_elem0_carry__2_i_2_n_0\,
      O(3 downto 0) => data0(15 downto 12),
      S(3) => \Current_elem0_carry__2_i_3_n_0\,
      S(2) => \Current_elem0_carry__2_i_4_n_0\,
      S(1) => controller_inst_n_10,
...
\Current_elem0_carry__2_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
\First_elem_next_window0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => First_elem_next_window(6 downto 4),
      ...
      S(3) => First_elem_next_window(7),
      S(2) => controller_inst_n_8,
...
\First_elem_next_window0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => First_elem_next_window(11 downto 10),
      DI(1) => '0',
      DI(0) => First_elem_next_window(8),
...
\Newest_buffered_elem[12]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00004000"
    )
        port map (
...
\Newest_buffered_elem_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(2 downto 1) => Newest_buffered_elem_reg(6 downto 5),
      S(0) => \Newest_buffered_elem[4]_i_3_n_0\
    );
...
\Position_in_window[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\Position_in_window[9]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"000B"
    )
        port map (
...
\Position_in_window[9]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7FF0800"
    )
        port map (
...
\Position_in_window[9]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00008000"
    )
        port map (
...
\Position_in_window[9]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\Position_in_window_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => controller_inst_n_56,
      S(2) => controller_inst_n_57,
      S(1) => controller_inst_n_58,
      S(0) => controller_inst_n_59
    );
\Window_buffer_read_addr_reg1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \Window_buffer_read_addr_reg1_carry__1_i_1_n_0\,
      DI(2) => controller_inst_n_36,
      DI(1) => controller_inst_n_37,
      DI(0) => addr_incr0,
      ...
      S(3) => controller_inst_n_16,
      S(2) => controller_inst_n_17,
...
\Window_buffer_read_addr_reg1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_Window_buffer_read_addr_reg1_carry__2_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \Window_buffer_read_addr_reg1_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \Window_buffer_read_addr_reg1_carry__2_i_1_n_0\,
      O(3 downto 2) => \NLW_Window_buffer_read_addr_reg1_carry__2_O_UNCONNECTED\(3 downto 2),
      O(1) => \Window_buffer_read_addr_reg1_carry__2_n_6\,
      O(0) => \Window_buffer_read_addr_reg1_carry__2_n_7\,
      S(3 downto 2) => B"00",
      S(1) => controller_inst_n_46,
      S(0) => controller_inst_n_47
    );
\Window_buffer_read_addr_reg1_carry__2_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
\Window_buffer_read_addr_reg[5]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0101000102020002"
    )
        port map (
...
\Window_buffer_read_addr_reg[5]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000008A"
    )
        port map (
...
controller_inst: entity work.finn_design_ConvolutionInputGenerator_rtl_6_0_swg_controller
     port map (
      ...
      \Current_elem_reg[0]\(0) => controller_inst_n_50,
      \Current_elem_reg[11]\(3) => controller_inst_n_12,
      \Current_elem_reg[11]\(2) => controller_inst_n_13,
      \Current_elem_reg[11]\(1) => controller_inst_n_14,
      \Current_elem_reg[11]\(0) => controller_inst_n_15,
      \Current_elem_reg[14]\(3) => controller_inst_n_38,
      \Current_elem_reg[14]\(2) => controller_inst_n_39,
      \Current_elem_reg[14]\(1) => controller_inst_n_40,
      \Current_elem_reg[14]\(0) => controller_inst_n_41,
      \Current_elem_reg[15]\ => \Current_elem[15]_i_5_n_0\,
      \Current_elem_reg[15]_0\(3 downto 0) => data0(15 downto 12),
      \Current_elem_reg[7]\(3) => controller_inst_n_51,
      \Current_elem_reg[7]\(2) => controller_inst_n_52,
      \Current_elem_reg[7]\(1) => controller_inst_n_53,
      \Current_elem_reg[7]\(0) => controller_inst_n_54,
      D(3 downto 0) => p_1_in(15 downto 12),
      DI(0) => \Window_buffer_read_addr_reg[9]_i_2_n_0\,
      Fetching_done_reg => controller_inst_n_20,
      Fetching_done_reg_0(10) => controller_inst_n_25,
      Fetching_done_reg_0(9) => controller_inst_n_26,
      Fetching_done_reg_0(8) => controller_inst_n_27,
      Fetching_done_reg_0(7) => controller_inst_n_28,
      Fetching_done_reg_0(6) => controller_inst_n_29,
      Fetching_done_reg_0(5) => controller_inst_n_30,
      Fetching_done_reg_0(4) => controller_inst_n_31,
      Fetching_done_reg_0(3) => controller_inst_n_32,
      Fetching_done_reg_0(2) => controller_inst_n_33,
      Fetching_done_reg_0(1) => controller_inst_n_34,
      Fetching_done_reg_0(0) => controller_inst_n_35,
      \First_elem_next_window_reg[11]\(2) => controller_inst_n_5,
      \First_elem_next_window_reg[11]\(1) => controller_inst_n_6,
      \First_elem_next_window_reg[11]\(0) => controller_inst_n_7,
      \First_elem_next_window_reg[6]\(1) => controller_inst_n_8,
      \First_elem_next_window_reg[6]\(0) => controller_inst_n_9,
      Newest_buffered_elem_reg(7 downto 0) => Newest_buffered_elem_reg(15 downto 8),
      \Newest_buffered_elem_reg[15]\(3) => controller_inst_n_42,
      \Newest_buffered_elem_reg[15]\(2) => controller_inst_n_43,
      \Newest_buffered_elem_reg[15]\(1) => controller_inst_n_44,
      \Newest_buffered_elem_reg[15]\(0) => controller_inst_n_45,
      O(1) => \Window_buffer_read_addr_reg1_carry__2_n_6\,
      O(0) => \Window_buffer_read_addr_reg1_carry__2_n_7\,
      Q(8 downto 7) => First_elem_next_window(11 downto 10),
      Q(6) => First_elem_next_window(8),
      Q(5) => First_elem_next_window(6),
      Q(4 downto 0) => First_elem_next_window(4 downto 0),
      S(3) => controller_inst_n_1,
      S(2) => controller_inst_n_2,
      S(1) => controller_inst_n_3,
      S(0) => controller_inst_n_4,
      \State_reg[0]_0\(1) => controller_inst_n_36,
      \State_reg[0]_0\(0) => controller_inst_n_37,
      \State_reg[0]_1\(1) => controller_inst_n_48,
      \State_reg[0]_1\(0) => controller_inst_n_49,
      \State_reg[2]_0\(1) => controller_inst_n_10,
      \State_reg[2]_0\(0) => controller_inst_n_11,
      \Window_buffer_read_addr_reg1_carry__2\(9) => \Window_buffer_read_addr_reg_reg_n_0_[12]\,
      \Window_buffer_read_addr_reg1_carry__2\(8 downto 1) => read_addr(11 downto 4),
      \Window_buffer_read_addr_reg1_carry__2\(0) => read_addr(0),
      \Window_buffer_read_addr_reg_reg[0]\(0) => controller_inst_n_55,
      \Window_buffer_read_addr_reg_reg[11]\(3) => controller_inst_n_16,
      \Window_buffer_read_addr_reg_reg[11]\(2) => controller_inst_n_17,
      \Window_buffer_read_addr_reg_reg[11]\(1) => controller_inst_n_18,
      \Window_buffer_read_addr_reg_reg[11]\(0) => controller_inst_n_19,
      \Window_buffer_read_addr_reg_reg[12]\(1) => controller_inst_n_46,
      \Window_buffer_read_addr_reg_reg[12]\(0) => controller_inst_n_47,
      \Window_buffer_read_addr_reg_reg[12]_0\(2) => \Window_buffer_read_addr_reg1_carry__1_n_4\,
      \Window_buffer_read_addr_reg_reg[12]_0\(1) => \Window_buffer_read_addr_reg1_carry__1_n_5\,
      \Window_buffer_read_addr_reg_reg[12]_0\(0) => \Window_buffer_read_addr_reg1_carry__1_n_7\,
      \Window_buffer_read_addr_reg_reg[5]\(1) => \Window_buffer_read_addr_reg[5]_i_5_n_0\,
      \Window_buffer_read_addr_reg_reg[5]\(0) => \Window_buffer_read_addr_reg[5]_i_7_n_0\,
      \Window_buffer_read_addr_reg_reg[5]_0\(0) => Window_buffer_read_addr_reg1_carry_n_4,
      \Window_buffer_read_addr_reg_reg[7]\(3) => controller_inst_n_56,
      \Window_buffer_read_addr_reg_reg[7]\(2) => controller_inst_n_57,
      \Window_buffer_read_addr_reg_reg[7]\(1) => controller_inst_n_58,
      \Window_buffer_read_addr_reg_reg[7]\(0) => controller_inst_n_59,
      \Window_buffer_read_addr_reg_reg[9]\(1) => \Window_buffer_read_addr_reg[9]_i_5_n_0\,
      \Window_buffer_read_addr_reg_reg[9]\(0) => \Window_buffer_read_addr_reg[9]_i_7_n_0\,
      \Window_buffer_read_addr_reg_reg[9]_0\(1) => \Window_buffer_read_addr_reg1_carry__0_n_5\,
      \Window_buffer_read_addr_reg_reg[9]_0\(0) => \Window_buffer_read_addr_reg1_carry__0_n_6\,
      addr_incr0 => addr_incr0,
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      \fetch_cmd2_carry__0\(12 downto 1) => Current_elem(15 downto 4),
...
\fetch_cmd2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => controller_inst_n_42,
      DI(2) => controller_inst_n_43,
      DI(1) => controller_inst_n_44,
      DI(0) => controller_inst_n_45,
      O(3 downto 0) => \NLW_fetch_cmd2_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => controller_inst_n_38,
      S(2) => controller_inst_n_39,
      S(1) => controller_inst_n_40,
      S(0) => controller_inst_n_41
    );
...
read_cmd3_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3 downto 2) => Newest_buffered_elem_reg(4 downto 3),
      DI(1 downto 0) => B"00",
      O(3 downto 0) => read_cmd3(4 downto 1),
      S(3) => read_cmd3_carry_i_1_n_0,
      S(2) => read_cmd3_carry_i_2_n_0,
...
window_buffer_inst: entity work.finn_design_ConvolutionInputGenerator_rtl_6_0_swg_cyclic_buffer_addressable
     port map (
      CO(0) => \read_cmd2__9\,
      DI(0) => window_buffer_inst_n_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6 is
  port (
    out_V_TDATA : out STD_LOGIC_VECTOR ( 2 downto 0 );
    in0_V_TREADY : out STD_LOGIC;
    out_V_TVALID : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6 : entity is "ConvolutionInputGenerator_rtl_6";
end finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6 is
begin
impl: entity work.finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6_impl
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(2 downto 0) => in0_V_TDATA(2 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_ConvolutionInputGenerator_rtl_6_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of finn_design_ConvolutionInputGenerator_rtl_6_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_ConvolutionInputGenerator_rtl_6_0 : entity is "finn_design_ConvolutionInputGenerator_rtl_6_0,ConvolutionInputGenerator_rtl_6,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_ConvolutionInputGenerator_rtl_6_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_ConvolutionInputGenerator_rtl_6_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_ConvolutionInputGenerator_rtl_6_0 : entity is "ConvolutionInputGenerator_rtl_6,Vivado 2022.2";
end finn_design_ConvolutionInputGenerator_rtl_6_0;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_6_0 is
...
inst: entity work.finn_design_ConvolutionInputGenerator_rtl_6_0_ConvolutionInputGenerator_rtl_6
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(2 downto 0) => in0_V_TDATA(2 downto 0),
