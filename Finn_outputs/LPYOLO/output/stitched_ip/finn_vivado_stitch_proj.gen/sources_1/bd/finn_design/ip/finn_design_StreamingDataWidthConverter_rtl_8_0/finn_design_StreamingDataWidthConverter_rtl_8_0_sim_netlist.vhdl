...
-- Date        : Mon Feb 16 18:39:16 2026
-- Host        : patanjali-slpsk running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/ug_lab/finn/notebooks/pls5/output/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_rtl_8_0/finn_design_StreamingDataWidthConverter_rtl_8_0_sim_netlist.vhdl
...
entity finn_design_StreamingDataWidthConverter_rtl_8_0_dwc is
  port (
  ...
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_8_0_dwc : entity is "dwc";
end finn_design_StreamingDataWidthConverter_rtl_8_0_dwc;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_8_0_dwc is
  ...
  signal \genUp.ADat[15][2]_i_1_n_0\ : STD_LOGIC;
  ...
  signal p_15_in : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute SOFT_HLUTNM of \genUp.ADat[15][1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \genUp.ADat[15][2]_i_2\ : label is "soft_lutpair2";
...
\genUp.ACnt[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF4"
    )
        port map (
...
\genUp.ADat[15][0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[15][1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[15][2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D0DD"
    )
        port map (
      ...
      I2 => in0_V_TVALID,
      I3 => \^s_axis_tready\,
      O => \genUp.ADat[15][2]_i_1_n_0\
    );
\genUp.ADat[15][2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_8_0_dwc_axi is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_8_0_dwc_axi : entity is "dwc_axi";
end finn_design_StreamingDataWidthConverter_rtl_8_0_dwc_axi;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_8_0_dwc_axi is
begin
core: entity work.finn_design_StreamingDataWidthConverter_rtl_8_0_dwc
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_8_0_StreamingDataWidthConverter_rtl_8 is
  port (
    out_V_TVALID : out STD_LOGIC;
    s_axis_tready : out STD_LOGIC;
    out_V_TDATA : out STD_LOGIC_VECTOR ( 47 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_8_0_StreamingDataWidthConverter_rtl_8 : entity is "StreamingDataWidthConverter_rtl_8";
end finn_design_StreamingDataWidthConverter_rtl_8_0_StreamingDataWidthConverter_rtl_8;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_8_0_StreamingDataWidthConverter_rtl_8 is
begin
impl: entity work.finn_design_StreamingDataWidthConverter_rtl_8_0_dwc_axi
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(2 downto 0) => in0_V_TDATA(2 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_8_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of finn_design_StreamingDataWidthConverter_rtl_8_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_StreamingDataWidthConverter_rtl_8_0 : entity is "finn_design_StreamingDataWidthConverter_rtl_8_0,StreamingDataWidthConverter_rtl_8,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_StreamingDataWidthConverter_rtl_8_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_StreamingDataWidthConverter_rtl_8_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_StreamingDataWidthConverter_rtl_8_0 : entity is "StreamingDataWidthConverter_rtl_8,Vivado 2022.2";
end finn_design_StreamingDataWidthConverter_rtl_8_0;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_8_0 is
...
begin
inst: entity work.finn_design_StreamingDataWidthConverter_rtl_8_0_StreamingDataWidthConverter_rtl_8
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(2 downto 0) => in0_V_TDATA(2 downto 0),
