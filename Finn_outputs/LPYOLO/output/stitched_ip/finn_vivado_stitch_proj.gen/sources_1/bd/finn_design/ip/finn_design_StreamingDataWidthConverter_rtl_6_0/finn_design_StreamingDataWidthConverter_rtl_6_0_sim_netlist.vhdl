...
--               /home/ug_lab/finn/notebooks/pls5/output/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_rtl_6_0/finn_design_StreamingDataWidthConverter_rtl_6_0_sim_netlist.vhdl
-- Design      : finn_design_StreamingDataWidthConverter_rtl_6_0
...
entity finn_design_StreamingDataWidthConverter_rtl_6_0_dwc is
  port (
  ...
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_6_0_dwc : entity is "dwc";
end finn_design_StreamingDataWidthConverter_rtl_6_0_dwc;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_6_0_dwc is
  ...
  attribute SOFT_HLUTNM of \genDown.ADat[0][1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \genDown.ADat[0][2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \genDown.ADat[1][0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genDown.ADat[1][1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genDown.ADat[1][2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genDown.ADat[2][0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \genDown.ADat[2][1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \genDown.ADat[2][2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genDown.ADat[3][0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \genDown.ADat[3][1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genDown.ADat[3][2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genDown.ADat[4][0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \genDown.ADat[4][1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \genDown.ADat[4][2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \genDown.ADat[5][0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \genDown.ADat[5][1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \genDown.ADat[5][2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \genDown.ADat[6][0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \genDown.ADat[6][1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \genDown.ADat[6][2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \genDown.BDat[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \genDown.BDat[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \genDown.BRdy0\ : label is "soft_lutpair1";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_6_0_dwc_axi is
  port (
    m_axis_tvalid : out STD_LOGIC;
    out_V_TDATA : out STD_LOGIC_VECTOR ( 2 downto 0 );
    in0_V_TREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_6_0_dwc_axi : entity is "dwc_axi";
end finn_design_StreamingDataWidthConverter_rtl_6_0_dwc_axi;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_6_0_dwc_axi is
begin
core: entity work.finn_design_StreamingDataWidthConverter_rtl_6_0_dwc
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_6_0_StreamingDataWidthConverter_rtl_6 is
  port (
    m_axis_tvalid : out STD_LOGIC;
    out_V_TDATA : out STD_LOGIC_VECTOR ( 2 downto 0 );
    in0_V_TREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_6_0_StreamingDataWidthConverter_rtl_6 : entity is "StreamingDataWidthConverter_rtl_6";
end finn_design_StreamingDataWidthConverter_rtl_6_0_StreamingDataWidthConverter_rtl_6;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_6_0_StreamingDataWidthConverter_rtl_6 is
begin
impl: entity work.finn_design_StreamingDataWidthConverter_rtl_6_0_dwc_axi
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(23 downto 0) => in0_V_TDATA(23 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_6_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
    in0_V_TREADY : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of finn_design_StreamingDataWidthConverter_rtl_6_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_StreamingDataWidthConverter_rtl_6_0 : entity is "finn_design_StreamingDataWidthConverter_rtl_6_0,StreamingDataWidthConverter_rtl_6,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_StreamingDataWidthConverter_rtl_6_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_StreamingDataWidthConverter_rtl_6_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_StreamingDataWidthConverter_rtl_6_0 : entity is "StreamingDataWidthConverter_rtl_6,Vivado 2022.2";
end finn_design_StreamingDataWidthConverter_rtl_6_0;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_6_0 is
...
inst: entity work.finn_design_StreamingDataWidthConverter_rtl_6_0_StreamingDataWidthConverter_rtl_6
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(23 downto 0) => in0_V_TDATA(23 downto 0),
