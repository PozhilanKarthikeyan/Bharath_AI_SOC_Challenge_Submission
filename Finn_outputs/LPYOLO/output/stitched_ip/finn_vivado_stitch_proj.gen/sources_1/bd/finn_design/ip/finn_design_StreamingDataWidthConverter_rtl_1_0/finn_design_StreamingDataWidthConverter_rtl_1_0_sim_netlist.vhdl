...
-- Date        : Mon Feb 16 18:42:44 2026
-- Host        : patanjali-slpsk running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/ug_lab/finn/notebooks/pls5/output/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_rtl_1_0/finn_design_StreamingDataWidthConverter_rtl_1_0_sim_netlist.vhdl
...
architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_1_0_dwc is
  ...
  signal \genUp.ADat[8][7]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \genUp.ADat[8][0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \genUp.ADat[8][1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \genUp.ADat[8][2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \genUp.ADat[8][3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \genUp.ADat[8][4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genUp.ADat[8][5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genUp.ADat[8][6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genUp.ADat[8][7]_i_2\ : label is "soft_lutpair4";
begin
...
\genUp.ADat[8][2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[8][3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[8][4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[8][5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[8][6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
\genUp.ADat[8][7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D0DD"
    )
        port map (
      ...
      I2 => in0_V_TVALID,
      I3 => \^s_axis_tready\,
      O => \genUp.ADat[8][7]_i_1_n_0\
    );
\genUp.ADat[8][7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
entity finn_design_StreamingDataWidthConverter_rtl_1_0 is
  ...
  attribute X_CORE_INFO of finn_design_StreamingDataWidthConverter_rtl_1_0 : entity is "StreamingDataWidthConverter_rtl_1,Vivado 2022.2";
