...
-- Date        : Mon Feb 16 18:42:36 2026
-- Host        : patanjali-slpsk running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/ug_lab/finn/notebooks/pls5/output/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_rtl_0_0/finn_design_StreamingDataWidthConverter_rtl_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_0_0_dwc is
  ...
  attribute SOFT_HLUTNM of \genDown.ACnt[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \genDown.ACnt[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \genDown.ADat[0][0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \genDown.ADat[0][1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \genDown.ADat[0][2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \genDown.ADat[0][3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \genDown.ADat[0][4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genDown.ADat[0][5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genDown.ADat[0][6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \genDown.ADat[0][7]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \genDown.ADat[1][6]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \genDown.ADat[1][7]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \genDown.CDat[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \genDown.CDat[1]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \genDown.CDat[7]_i_2\ : label is "soft_lutpair12";
begin
  E(0) <= \^e\(0);
  m_axis_tvalid <= \^m_axis_tvalid\;
\genDown.ACnt[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5A3A"
    )
        port map (
...
\genDown.ACnt[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6FCC60CC"
    )
        port map (
...
entity finn_design_StreamingDataWidthConverter_rtl_0_0 is
  ...
  attribute X_CORE_INFO of finn_design_StreamingDataWidthConverter_rtl_0_0 : entity is "StreamingDataWidthConverter_rtl_0,Vivado 2022.2";
