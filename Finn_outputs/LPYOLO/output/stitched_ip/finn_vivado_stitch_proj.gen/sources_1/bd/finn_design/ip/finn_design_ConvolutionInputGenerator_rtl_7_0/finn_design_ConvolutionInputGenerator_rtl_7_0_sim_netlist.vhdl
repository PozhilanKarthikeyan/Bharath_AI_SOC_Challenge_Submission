...
-- Date        : Mon Feb 16 18:40:46 2026
-- Host        : patanjali-slpsk running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/ug_lab/finn/notebooks/pls5/output/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_ConvolutionInputGenerator_rtl_7_0/finn_design_ConvolutionInputGenerator_rtl_7_0_sim_netlist.vhdl
...
entity finn_design_ConvolutionInputGenerator_rtl_7_0_swg_controller is
  port (
    addr_incr0 : out STD_LOGIC;
    \Window_buffer_read_addr_reg_reg[9]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    S : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \First_elem_next_window_reg[10]\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
    \First_elem_next_window_reg[7]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    DI : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \Window_buffer_read_addr_reg_reg[11]\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
    \State_reg[2]_0\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    D : out STD_LOGIC_VECTOR ( 2 downto 0 );
    out_V_TREADY_0 : out STD_LOGIC_VECTOR ( 9 downto 0 );
    ...
    Newest_buffered_elem_reg : in STD_LOGIC_VECTOR ( 6 downto 0 );
    \fetch_cmd2_carry__0\ : in STD_LOGIC_VECTOR ( 11 downto 0 );
    \Window_buffer_read_addr_reg1_carry__1\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    \Current_elem_reg[14]_0\ : in STD_LOGIC;
    ...
    \Window_buffer_read_addr_reg_reg[9]_1\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME of finn_design_ConvolutionInputGenerator_rtl_7_0_swg_controller : entity is "swg_controller";
end finn_design_ConvolutionInputGenerator_rtl_7_0_swg_controller;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_7_0_swg_controller is
  signal Counter_loop_h : STD_LOGIC;
  signal Counter_loop_h0 : STD_LOGIC_VECTOR ( 4 downto 0 );
  signal \Counter_loop_h[4]_i_1_n_0\ : STD_LOGIC;
  signal Counter_loop_h_reg : STD_LOGIC_VECTOR ( 4 to 4 );
  ...
  signal \Counter_loop_simd[6]_i_6_n_0\ : STD_LOGIC;
  ...
  signal Counter_loop_w0 : STD_LOGIC_VECTOR ( 4 downto 0 );
  signal \Counter_loop_w[4]_i_1_n_0\ : STD_LOGIC;
  signal Counter_loop_w_reg : STD_LOGIC_VECTOR ( 4 to 4 );
  ...
  signal tail_incr : STD_LOGIC_VECTOR ( 4 to 4 );
  ...
  signal \NLW_Window_buffer_read_addr_reg_reg[11]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_Window_buffer_read_addr_reg_reg[11]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Counter_loop_h[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Counter_loop_h[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Counter_loop_h[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Counter_loop_h[4]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Counter_loop_simd[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \Counter_loop_simd[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Counter_loop_simd[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \Counter_loop_simd[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Counter_loop_simd[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Counter_loop_simd[6]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Counter_loop_simd[6]_i_6\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Counter_loop_w[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Counter_loop_w[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Counter_loop_w[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Counter_loop_w[4]_i_3\ : label is "soft_lutpair2";
...
\Counter_loop_h[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"80000000FFFFFFFF"
    )
        port map (
      I0 => Counter_loop_w_reg(4),
      I1 => Counter_loop_h_reg(4),
...
\Counter_loop_h[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      ...
      I4 => Counter_loop_w_reg(4),
      O => Counter_loop_h
    );
\Counter_loop_h[4]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0001"
    )
        port map (
      ...
      I2 => \Counter_loop_h_reg_n_0_[0]\,
      I3 => \Counter_loop_h_reg_n_0_[2]\,
      I4 => Counter_loop_h_reg(4),
      O => Counter_loop_h0(4)
    );
\Counter_loop_h_reg[0]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '1'
    )
        port map (
...
\Counter_loop_kh[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => out_V_TREADY,
      I4 => \Counter_loop_simd[6]_i_5_n_0\,
...
\Counter_loop_simd[6]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E1"
        ...
        port map (
      I0 => \Counter_loop_simd_reg_n_0_[5]\,
      I1 => \Counter_loop_simd[6]_i_6_n_0\,
      I2 => Counter_loop_simd_reg(6),
      O => Counter_loop_simd0(6)
    );
\Counter_loop_simd[6]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EEFE"
    )
        port map (
...
\Counter_loop_simd[6]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\Counter_loop_simd[6]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      ...
      O => \Counter_loop_simd[6]_i_6_n_0\
    );
...
\Counter_loop_w[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"80000000FFFFFFFF"
    )
        port map (
...
\Counter_loop_w[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\Counter_loop_w[4]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0001"
    )
        port map (
...
\Current_elem[14]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000008A00000000"
    )
        port map (
...
\First_elem_next_window0_carry__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A6"
    )
        port map (
      I0 => Q(5),
      I1 => Counter_loop_w_reg(4),
      I2 => Counter_loop_h_reg(4),
      O => \First_elem_next_window_reg[7]\(1)
    );
\First_elem_next_window0_carry__0_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"59"
    )
        port map (
      ...
      I1 => Counter_loop_w_reg(4),
      I2 => Counter_loop_h_reg(4),
      O => \First_elem_next_window_reg[7]\(0)
    );
\First_elem_next_window0_carry__1_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
      I0 => Q(8),
      I1 => Counter_loop_h_reg(4),
      I2 => Counter_loop_w_reg(4),
      O => \First_elem_next_window_reg[10]\(2)
    );
\First_elem_next_window0_carry__1_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
\First_elem_next_window0_carry__1_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
First_elem_next_window0_carry_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"95"
    )
        port map (
...
First_elem_next_window0_carry_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
First_elem_next_window0_carry_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
First_elem_next_window0_carry_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__0_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
\Window_buffer_read_addr_reg1_carry__1_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
        ...
        port map (
      I0 => \Window_buffer_read_addr_reg1_carry__1\(7),
      I1 => \^addr_incr0\,
...
\Window_buffer_read_addr_reg1_carry__1_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\Window_buffer_read_addr_reg[5]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0E01"
    )
        port map (
      ...
      I1 => CO(0),
      I2 => \^fetching_done_reg\,
      I3 => \Window_buffer_read_addr_reg_reg[9]_1\(1),
      O => \Window_buffer_read_addr_reg[5]_i_3_n_0\
    );
\Window_buffer_read_addr_reg[5]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0E01"
    )
        port map (
      ...
      I1 => CO(0),
      I2 => \^fetching_done_reg\,
      I3 => \Window_buffer_read_addr_reg_reg[9]_1\(0),
...
\Window_buffer_read_addr_reg[9]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0E01"
    )
        port map (
...
\Window_buffer_read_addr_reg[9]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0E01"
    )
        port map (
...
\Window_buffer_read_addr_reg[9]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0101000102020002"
    )
        port map (
      ...
      I3 => \Counter_loop_simd_reg[0]_0\,
      I4 => out_V_TREADY,
      I5 => \Window_buffer_read_addr_reg_reg[9]_1\(3),
...
\Window_buffer_read_addr_reg[9]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \Counter_loop_simd_reg[0]_0\,
      I4 => out_V_TREADY,
      I5 => \Window_buffer_read_addr_reg_reg[9]_1\(2),
...
\Window_buffer_read_addr_reg_reg[11]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_Window_buffer_read_addr_reg_reg[11]_i_2_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \Window_buffer_read_addr_reg_reg[11]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \Window_buffer_read_addr_reg[11]_i_3_n_0\,
      O(3 downto 2) => \NLW_Window_buffer_read_addr_reg_reg[11]_i_2_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => out_V_TREADY_0(9 downto 8),
      S(3 downto 2) => B"00",
      S(1) => \Window_buffer_read_addr_reg[11]_i_4_n_0\,
      S(0) => \Window_buffer_read_addr_reg[11]_i_5_n_0\
    );
\Window_buffer_read_addr_reg_reg[5]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \Window_buffer_read_addr_reg[11]_i_3_n_0\,
      DI(2) => \Window_buffer_read_addr_reg[11]_i_3_n_0\,
      DI(1) => \Window_buffer_read_addr_reg[5]_i_2_n_0\,
      DI(0) => '0',
      O(3 downto 0) => out_V_TREADY_0(3 downto 0),
      S(3) => \Window_buffer_read_addr_reg[5]_i_3_n_0\,
      S(2) => \Window_buffer_read_addr_reg[5]_i_4_n_0\,
      S(1) => \Window_buffer_read_addr_reg[5]_i_5_n_0\,
...
\Window_buffer_read_addr_reg_reg[9]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3) => \Window_buffer_read_addr_reg[11]_i_3_n_0\,
      DI(2) => \Window_buffer_read_addr_reg[11]_i_3_n_0\,
      DI(1) => \Window_buffer_read_addr_reg[9]_i_2_n_0\,
      DI(0) => \Window_buffer_read_addr_reg[9]_i_2_n_0\,
      O(3 downto 0) => out_V_TREADY_0(7 downto 4),
      S(3) => \Window_buffer_read_addr_reg[9]_i_3_n_0\,
      S(2) => \Window_buffer_read_addr_reg[9]_i_4_n_0\,
      S(1) => \Window_buffer_read_addr_reg[9]_i_5_n_0\,
      S(0) => \Window_buffer_read_addr_reg[9]_i_6_n_0\
    );
...
\fetch_cmd2_carry__0_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_ConvolutionInputGenerator_rtl_7_0_swg_cyclic_buffer_addressable is
  port (
    ...
    S : out STD_LOGIC_VECTOR ( 3 downto 0 );
    DI : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \Newest_buffered_elem_reg[14]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \First_elem_next_window_reg[14]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \First_elem_next_window_reg[14]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    out_V_TDATA : out STD_LOGIC_VECTOR ( 2 downto 0 );
    Newest_buffered_elem_reg : in STD_LOGIC_VECTOR ( 14 downto 0 );
    in0_V_TVALID : in STD_LOGIC;
    CO : in STD_LOGIC_VECTOR ( 0 to 0 );
    \Newest_buffered_elem_reg[14]_0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \Out_reg[0]_0\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 6 downto 0 );
    read_cmd3 : in STD_LOGIC_VECTOR ( 6 downto 0 );
    \read_cmd2_inferred__0/i__carry__0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \read_cmd2_inferred__0/i__carry__0_0\ : in STD_LOGIC_VECTOR ( 6 downto 0 );
    ap_clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_ConvolutionInputGenerator_rtl_7_0_swg_cyclic_buffer_addressable : entity is "swg_cyclic_buffer_addressable";
end finn_design_ConvolutionInputGenerator_rtl_7_0_swg_cyclic_buffer_addressable;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_7_0_swg_cyclic_buffer_addressable is
  ...
  attribute RTL_RAM_BITS of Ram_reg_0_63_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1024_1087_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1088_1151_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1152_1215_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1216_1279_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1280_1343_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_128_191_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1344_1407_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1408_1471_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1472_1535_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1536_1599_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1600_1663_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1664_1727_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1728_1791_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_1792_1855_0_2 : label is 5544;
  ...
  attribute ram_addr_end of Ram_reg_1792_1855_0_2 : label is 1847;
  ...
  attribute RTL_RAM_BITS of Ram_reg_192_255_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_256_319_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_320_383_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_384_447_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_448_511_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_512_575_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_576_639_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_640_703_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_64_127_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_704_767_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_768_831_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_832_895_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_896_959_0_2 : label is 5544;
  ...
  attribute RTL_RAM_BITS of Ram_reg_960_1023_0_2 : label is 5544;
...
\Window_buffer_write_addr_reg[10]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => Newest_buffered_elem_reg_10_sn_1,
      I2 => in0_V_TVALID,
      I3 => CO(0),
      I4 => \Newest_buffered_elem_reg[14]_0\(0),
      I5 => \Out_reg[0]_0\,
      O => \^p_21_in\
    );
\i__carry__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"07"
        ...
        port map (
      I0 => read_cmd3(6),
      I1 => \read_cmd2_inferred__0/i__carry__0_0\(6),
      I2 => \read_cmd2_inferred__0/i__carry__0\(0),
      O => \First_elem_next_window_reg[14]\(3)
    );
\i__carry__0_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
        ...
        port map (
      I0 => \read_cmd2_inferred__0/i__carry__0_0\(5),
      I1 => read_cmd3(5),
      I2 => \read_cmd2_inferred__0/i__carry__0_0\(4),
      I3 => read_cmd3(4),
      O => \First_elem_next_window_reg[14]\(2)
    );
\i__carry__0_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
        ...
        port map (
      I0 => \read_cmd2_inferred__0/i__carry__0_0\(3),
      I1 => read_cmd3(3),
      I2 => \read_cmd2_inferred__0/i__carry__0_0\(2),
      I3 => read_cmd3(2),
      O => \First_elem_next_window_reg[14]\(1)
    );
\i__carry__0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22B2"
        ...
        port map (
      I0 => \read_cmd2_inferred__0/i__carry__0_0\(1),
      I1 => read_cmd3(1),
      I2 => \read_cmd2_inferred__0/i__carry__0_0\(0),
      I3 => read_cmd3(0),
      O => \First_elem_next_window_reg[14]\(0)
    );
\i__carry__0_i_5\: unisim.vcomponents.LUT3
    generic map(
      ...
      I1 => \read_cmd2_inferred__0/i__carry__0_0\(6),
      I2 => read_cmd3(6),
      O => \First_elem_next_window_reg[14]_0\(3)
    );
\i__carry__0_i_6\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \read_cmd2_inferred__0/i__carry__0_0\(4),
      I3 => read_cmd3(4),
      O => \First_elem_next_window_reg[14]_0\(2)
    );
\i__carry__0_i_7\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \read_cmd2_inferred__0/i__carry__0_0\(2),
      I3 => read_cmd3(2),
      O => \First_elem_next_window_reg[14]_0\(1)
    );
\i__carry__0_i_8\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \read_cmd2_inferred__0/i__carry__0_0\(0),
      I3 => read_cmd3(0),
      O => \First_elem_next_window_reg[14]_0\(0)
    );
in0_V_TREADY_INST_0_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I3 => Newest_buffered_elem_reg_4_sn_1,
...
\read_cmd2_carry__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"07"
    )
        port map (
...
\read_cmd2_carry__0_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"42"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7_impl is
  port (
    out_V_TDATA : out STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7_impl : entity is "ConvolutionInputGenerator_rtl_7_impl";
end finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7_impl;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7_impl is
  signal Current_elem : STD_LOGIC_VECTOR ( 14 downto 0 );
  ...
  signal \Current_elem[14]_i_10_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_11_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_12_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_2_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_4_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_5_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_6_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_7_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_8_n_0\ : STD_LOGIC;
  signal \Current_elem[14]_i_9_n_0\ : STD_LOGIC;
  ...
  signal First_elem_next_window : STD_LOGIC_VECTOR ( 14 downto 0 );
  signal \First_elem_next_window0_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__0_n_0\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__0_n_1\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__0_n_2\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__0_n_3\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__0_n_4\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__0_n_5\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__0_n_6\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__0_n_7\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__1_n_0\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__1_n_1\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__1_n_2\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__1_n_3\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__1_n_4\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__1_n_5\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__1_n_6\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__1_n_7\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__2_n_2\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__2_n_3\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__2_n_5\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__2_n_6\ : STD_LOGIC;
  signal \First_elem_next_window0_carry__2_n_7\ : STD_LOGIC;
  signal First_elem_next_window0_carry_n_0 : STD_LOGIC;
  signal First_elem_next_window0_carry_n_1 : STD_LOGIC;
  signal First_elem_next_window0_carry_n_2 : STD_LOGIC;
  signal First_elem_next_window0_carry_n_3 : STD_LOGIC;
  signal First_elem_next_window0_carry_n_4 : STD_LOGIC;
  signal First_elem_next_window0_carry_n_5 : STD_LOGIC;
  signal First_elem_next_window0_carry_n_6 : STD_LOGIC;
  signal First_elem_next_window0_carry_n_7 : STD_LOGIC;
  ...
  signal \First_elem_next_window[14]_i_2_n_0\ : STD_LOGIC;
  signal \First_elem_next_window[14]_i_3_n_0\ : STD_LOGIC;
  signal \First_elem_next_window[14]_i_4_n_0\ : STD_LOGIC;
  signal \First_elem_next_window[14]_i_5_n_0\ : STD_LOGIC;
  ...
  signal Newest_buffered_elem_reg : STD_LOGIC_VECTOR ( 14 downto 0 );
  ...
  signal \Position_in_window[7]_i_2_n_0\ : STD_LOGIC;
  signal \Position_in_window[8]_i_1_n_0\ : STD_LOGIC;
  signal \Position_in_window[8]_i_4_n_0\ : STD_LOGIC;
  signal \Position_in_window[8]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \Window_buffer_write_addr_reg[10]_i_6_n_0\ : STD_LOGIC;
  signal \Window_buffer_write_addr_reg[1]_i_1_n_0\ : STD_LOGIC;
  signal \Window_buffer_write_addr_reg[1]_i_2_n_0\ : STD_LOGIC;
  signal \Window_buffer_write_addr_reg[1]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \Window_buffer_write_addr_reg[8]_i_2_n_0\ : STD_LOGIC;
  signal \Window_buffer_write_addr_reg[9]_i_1_n_0\ : STD_LOGIC;
  signal \Window_buffer_write_addr_reg[9]_i_2_n_0\ : STD_LOGIC;
  ...
  signal data0 : STD_LOGIC_VECTOR ( 14 downto 0 );
  ...
  signal read_cmd3 : STD_LOGIC_VECTOR ( 14 downto 1 );
  ...
  signal \NLW_Current_elem0_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_Current_elem0_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_First_elem_next_window0_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_First_elem_next_window0_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_Newest_buffered_elem_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_Newest_buffered_elem_reg[12]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \NLW_read_cmd3_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_read_cmd3_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Current_elem[14]_i_12\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \Current_elem[14]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of Fetching_done_i_3 : label is "soft_lutpair19";
  attribute ADDER_THRESHOLD of First_elem_next_window0_carry : label is 35;
  attribute ADDER_THRESHOLD of \First_elem_next_window0_carry__0\ : label is 35;
  attribute ADDER_THRESHOLD of \First_elem_next_window0_carry__1\ : label is 35;
  attribute ADDER_THRESHOLD of \First_elem_next_window0_carry__2\ : label is 35;
  attribute SOFT_HLUTNM of \First_elem_next_window[0]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \First_elem_next_window[10]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \First_elem_next_window[11]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \First_elem_next_window[12]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \First_elem_next_window[13]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \First_elem_next_window[14]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \First_elem_next_window[14]_i_5\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \First_elem_next_window[1]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \First_elem_next_window[2]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \First_elem_next_window[3]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \First_elem_next_window[4]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \First_elem_next_window[5]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \First_elem_next_window[6]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \First_elem_next_window[7]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \First_elem_next_window[8]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \First_elem_next_window[9]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \Newest_buffered_elem[0]_i_5\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \Position_in_window[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \Position_in_window[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Position_in_window[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Position_in_window[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Position_in_window[7]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \Position_in_window[8]_i_3\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[10]_i_5\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[10]_i_6\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[1]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[2]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[5]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[8]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \Window_buffer_write_addr_reg[9]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of Write_cmd_i_1 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of in0_V_TREADY_INST_0_i_1 : label is "soft_lutpair19";
...
\Current_elem0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => controller_inst_n_41,
      S(2) => controller_inst_n_42,
      S(1) => controller_inst_n_43,
      S(0) => controller_inst_n_44
    );
...
\Current_elem0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_Current_elem0_carry__2_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \Current_elem0_carry__2_n_2\,
      CO(0) => \Current_elem0_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => Current_elem(12),
      DI(0) => controller_inst_n_39,
      O(3) => \NLW_Current_elem0_carry__2_O_UNCONNECTED\(3),
      O(2 downto 0) => data0(14 downto 12),
      S(3) => '0',
      S(2) => \Current_elem0_carry__2_i_2_n_0\,
      S(1) => \Current_elem0_carry__2_i_3_n_0\,
      S(0) => controller_inst_n_18
    );
...
\Current_elem[14]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"555F555D"
    )
        port map (
      I0 => ap_rst_n,
      I1 => in0_V_TVALID,
      I2 => \Current_elem[14]_i_4_n_0\,
      I3 => window_buffer_inst_n_1,
      I4 => Newest_buffered_elem_reg(0),
      O => Window_buffer_read_addr_reg
    );
\Current_elem[14]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => Current_elem(0),
      I1 => Current_elem(1),
      O => \Current_elem[14]_i_10_n_0\
    );
\Current_elem[14]_i_11\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => Current_elem(4),
      I1 => Current_elem(5),
      O => \Current_elem[14]_i_11_n_0\
    );
\Current_elem[14]_i_12\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      I0 => Newest_buffered_elem_reg(0),
      I1 => Writing_done,
      O => \Current_elem[14]_i_12_n_0\
    );
\Current_elem[14]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \fetch_cmd2_carry__0_n_0\,
      I4 => Fetching_done_reg_n_0,
      I5 => \Current_elem[14]_i_6_n_0\,
      O => \Current_elem[14]_i_2_n_0\
    );
\Current_elem[14]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
      ...
      O => \Current_elem[14]_i_4_n_0\
    );
\Current_elem[14]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => \Current_elem[14]_i_7_n_0\,
      I1 => \Current_elem[14]_i_8_n_0\,
      I2 => \Current_elem[14]_i_9_n_0\,
      I3 => Current_elem(14),
      I4 => \Current_elem[14]_i_10_n_0\,
      I5 => \Current_elem[14]_i_11_n_0\,
      O => \Current_elem[14]_i_5_n_0\
    );
\Current_elem[14]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => window_buffer_inst_n_1,
      I5 => \Current_elem[14]_i_12_n_0\,
      O => \Current_elem[14]_i_6_n_0\
    );
\Current_elem[14]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
      ...
      I2 => Current_elem(11),
      I3 => Current_elem(10),
      O => \Current_elem[14]_i_7_n_0\
    );
\Current_elem[14]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
      ...
      I2 => Current_elem(7),
      I3 => Current_elem(6),
      O => \Current_elem[14]_i_8_n_0\
    );
\Current_elem[14]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
Fetching_done_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \Current_elem[14]_i_6_n_0\,
      I3 => Fetching_done_reg_n_0,
      I4 => Fetching_done_i_3_n_0,
      I5 => \Current_elem[14]_i_4_n_0\,
...
First_elem_next_window0_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => First_elem_next_window0_carry_n_0,
      CO(2) => First_elem_next_window0_carry_n_1,
      CO(1) => First_elem_next_window0_carry_n_2,
      CO(0) => First_elem_next_window0_carry_n_3,
      CYINIT => '0',
      DI(3 downto 0) => First_elem_next_window(3 downto 0),
      O(3) => First_elem_next_window0_carry_n_4,
      O(2) => First_elem_next_window0_carry_n_5,
      O(1) => First_elem_next_window0_carry_n_6,
      O(0) => First_elem_next_window0_carry_n_7,
      S(3) => controller_inst_n_2,
      S(2) => controller_inst_n_3,
      S(1) => controller_inst_n_4,
      S(0) => controller_inst_n_5
    );
\First_elem_next_window0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => First_elem_next_window0_carry_n_0,
      CO(3) => \First_elem_next_window0_carry__0_n_0\,
      CO(2) => \First_elem_next_window0_carry__0_n_1\,
      CO(1) => \First_elem_next_window0_carry__0_n_2\,
      CO(0) => \First_elem_next_window0_carry__0_n_3\,
      CYINIT => '0',
      DI(3) => First_elem_next_window(7),
      DI(2) => '0',
      DI(1 downto 0) => First_elem_next_window(5 downto 4),
      O(3) => \First_elem_next_window0_carry__0_n_4\,
      O(2) => \First_elem_next_window0_carry__0_n_5\,
      O(1) => \First_elem_next_window0_carry__0_n_6\,
      O(0) => \First_elem_next_window0_carry__0_n_7\,
      S(3) => controller_inst_n_9,
      S(2) => First_elem_next_window(6),
      S(1) => \First_elem_next_window0_carry__0_i_2_n_0\,
      S(0) => controller_inst_n_10
    );
\First_elem_next_window0_carry__0_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\First_elem_next_window0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \First_elem_next_window0_carry__0_n_0\,
      CO(3) => \First_elem_next_window0_carry__1_n_0\,
      CO(2) => \First_elem_next_window0_carry__1_n_1\,
      CO(1) => \First_elem_next_window0_carry__1_n_2\,
      CO(0) => \First_elem_next_window0_carry__1_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => First_elem_next_window(10 downto 8),
      O(3) => \First_elem_next_window0_carry__1_n_4\,
      O(2) => \First_elem_next_window0_carry__1_n_5\,
      O(1) => \First_elem_next_window0_carry__1_n_6\,
      O(0) => \First_elem_next_window0_carry__1_n_7\,
      S(3) => First_elem_next_window(11),
      S(2) => controller_inst_n_6,
      S(1) => controller_inst_n_7,
      S(0) => controller_inst_n_8
    );
\First_elem_next_window0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      CI => \First_elem_next_window0_carry__1_n_0\,
      CO(3 downto 2) => \NLW_First_elem_next_window0_carry__2_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \First_elem_next_window0_carry__2_n_2\,
      CO(0) => \First_elem_next_window0_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_First_elem_next_window0_carry__2_O_UNCONNECTED\(3),
      O(2) => \First_elem_next_window0_carry__2_n_5\,
      O(1) => \First_elem_next_window0_carry__2_n_6\,
      O(0) => \First_elem_next_window0_carry__2_n_7\,
      S(3) => '0',
      S(2 downto 0) => First_elem_next_window(14 downto 12)
    );
\First_elem_next_window[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => First_elem_next_window0_carry_n_7,
...
\First_elem_next_window[10]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__1_n_5\,
...
\First_elem_next_window[11]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__1_n_4\,
...
\First_elem_next_window[12]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__2_n_7\,
...
\First_elem_next_window[13]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__2_n_6\,
...
\First_elem_next_window[14]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => \Current_elem[14]_i_6_n_0\,
      I1 => \First_elem_next_window[14]_i_3_n_0\,
      O => \First_elem_next_window[14]_i_1_n_0\
    );
\First_elem_next_window[14]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__2_n_5\,
      O => \First_elem_next_window[14]_i_2_n_0\
    );
\First_elem_next_window[14]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0002000200000002"
    )
        port map (
      I0 => \First_elem_next_window[14]_i_4_n_0\,
      I1 => Position_in_window_reg(3),
      I2 => Fetching_done_reg_n_0,
      I3 => \fetch_cmd2_carry__0_n_0\,
      I4 => Write_cmd_reg_n_0,
      I5 => out_V_TREADY,
      O => \First_elem_next_window[14]_i_3_n_0\
    );
\First_elem_next_window[14]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00010000"
    )
        port map (
      ...
      I4 => \First_elem_next_window[14]_i_5_n_0\,
      O => \First_elem_next_window[14]_i_4_n_0\
    );
\First_elem_next_window[14]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
      ...
      O => \First_elem_next_window[14]_i_5_n_0\
    );
\First_elem_next_window[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => First_elem_next_window0_carry_n_6,
...
\First_elem_next_window[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => First_elem_next_window0_carry_n_5,
...
\First_elem_next_window[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => First_elem_next_window0_carry_n_4,
...
\First_elem_next_window[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__0_n_7\,
...
\First_elem_next_window[5]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__0_n_6\,
...
\First_elem_next_window[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__0_n_5\,
...
\First_elem_next_window[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__0_n_4\,
...
\First_elem_next_window[8]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__1_n_7\,
...
\First_elem_next_window[9]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \First_elem_next_window[14]_i_3_n_0\,
      I1 => \First_elem_next_window0_carry__1_n_6\,
...
\First_elem_next_window_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => ap_clk,
      CE => \First_elem_next_window[14]_i_1_n_0\,
...
\First_elem_next_window_reg[14]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => ap_clk,
      CE => \First_elem_next_window[14]_i_1_n_0\,
      D => \First_elem_next_window[14]_i_2_n_0\,
...
\Newest_buffered_elem[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \Newest_buffered_elem[0]_i_6_n_0\,
...
\Newest_buffered_elem[0]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
...
\Newest_buffered_elem[0]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\Newest_buffered_elem[12]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => Newest_buffered_elem_reg(10),
      I2 => Newest_buffered_elem_reg(11),
      I3 => \Current_elem[14]_i_12_n_0\,
      I4 => \Newest_buffered_elem[12]_i_3_n_0\,
      I5 => Newest_buffered_elem_reg(14),
      O => \Newest_buffered_elem[12]_i_2_n_0\
    );
\Newest_buffered_elem[12]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\Newest_buffered_elem[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF02"
        ...
        port map (
      I0 => \Newest_buffered_elem[0]_i_5_n_0\,
      I1 => \Newest_buffered_elem[4]_i_4_n_0\,
...
\Newest_buffered_elem[4]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\Newest_buffered_elem_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \Newest_buffered_elem[0]_i_3_n_0\,
      S(2 downto 1) => Newest_buffered_elem_reg(2 downto 1),
...
\Newest_buffered_elem_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_Newest_buffered_elem_reg[12]_i_1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \Newest_buffered_elem_reg[12]_i_1_n_2\,
      CO(0) => \Newest_buffered_elem_reg[12]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_Newest_buffered_elem_reg[12]_i_1_O_UNCONNECTED\(3),
      ...
      S(1 downto 0) => Newest_buffered_elem_reg(13 downto 12)
    );
...
\Newest_buffered_elem_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(1 downto 0) => Newest_buffered_elem_reg(5 downto 4)
    );
...
\Position_in_window[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7FF0800"
    )
        port map (
...
\Position_in_window[8]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DF20"
    )
        port map (
      I0 => Position_in_window_reg(7),
      I1 => \Position_in_window[8]_i_5_n_0\,
      I2 => Position_in_window_reg(6),
      I3 => Position_in_window_reg(8),
      O => p_0_in(8)
    );
\Position_in_window[8]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000080000000"
    )
        port map (
      I0 => Position_in_window_reg(7),
      I1 => Position_in_window_reg(8),
      I2 => Position_in_window_reg(6),
      I3 => Position_in_window_reg(5),
      I4 => Position_in_window_reg(4),
      I5 => \Position_in_window[7]_i_2_n_0\,
      O => \Position_in_window[8]_i_4_n_0\
    );
\Position_in_window[8]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => Position_in_window_reg(3),
      I5 => Position_in_window_reg(5),
      O => \Position_in_window[8]_i_5_n_0\
    );
...
\Window_buffer_read_addr_reg1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => controller_inst_n_49,
      S(2) => controller_inst_n_50,
      S(1) => controller_inst_n_51,
...
\Window_buffer_read_addr_reg1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => controller_inst_n_15,
      S(2) => read_addr(10),
      S(1) => controller_inst_n_16,
      S(0) => controller_inst_n_17
    );
...
\Window_buffer_read_addr_reg[5]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000008A"
    )
        port map (
...
\Window_buffer_write_addr_reg[10]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"C9CCCCCCCCCCCCC8"
    )
        port map (
      I0 => \Window_buffer_write_addr_reg[10]_i_5_n_0\,
      I1 => write_addr(10),
      I2 => \Window_buffer_write_addr_reg[10]_i_6_n_0\,
      I3 => write_addr(3),
      I4 => write_addr(6),
      I5 => write_addr(7),
...
\Window_buffer_write_addr_reg[10]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\Window_buffer_write_addr_reg[10]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
      ...
      I3 => write_addr(0),
      I4 => write_addr(1),
      O => \Window_buffer_write_addr_reg[10]_i_6_n_0\
    );
\Window_buffer_write_addr_reg[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => write_addr(1),
      I1 => write_addr(0),
      I2 => \Window_buffer_write_addr_reg[1]_i_2_n_0\,
      I3 => write_addr(6),
      I4 => write_addr(10),
      I5 => write_addr(9),
      O => \Window_buffer_write_addr_reg[1]_i_1_n_0\
    );
\Window_buffer_write_addr_reg[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7FFF"
    )
        port map (
      ...
      I2 => write_addr(8),
      I3 => write_addr(2),
      I4 => \Window_buffer_write_addr_reg[1]_i_3_n_0\,
      O => \Window_buffer_write_addr_reg[1]_i_2_n_0\
    );
\Window_buffer_write_addr_reg[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
      ...
      I2 => write_addr(3),
      I3 => write_addr(7),
      O => \Window_buffer_write_addr_reg[1]_i_3_n_0\
    );
...
\Window_buffer_write_addr_reg[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF0000BF"
    )
        port map (
      I0 => \Window_buffer_write_addr_reg[5]_i_2_n_0\,
      I1 => write_addr(5),
      I2 => write_addr(4),
      I3 => \Window_buffer_write_addr_reg[7]_i_2_n_0\,
      I4 => write_addr(3),
...
\Window_buffer_write_addr_reg[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => write_addr(4),
      I2 => write_addr(3),
      I3 => \Window_buffer_write_addr_reg[5]_i_2_n_0\,
      I4 => \Window_buffer_write_addr_reg[7]_i_2_n_0\,
      O => \Window_buffer_write_addr_reg[4]_i_1_n_0\
    );
\Window_buffer_write_addr_reg[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"CCCC6C64"
    )
        port map (
...
\Window_buffer_write_addr_reg[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFF7F"
    )
        port map (
...
\Window_buffer_write_addr_reg[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF7F0080"
    )
        port map (
...
\Window_buffer_write_addr_reg[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"ABABABAB000000FF"
    )
        port map (
      I0 => \Window_buffer_write_addr_reg[9]_i_2_n_0\,
      I1 => write_addr(9),
      I2 => write_addr(3),
      I3 => \Window_buffer_write_addr_reg[9]_i_3_n_0\,
      I4 => \Window_buffer_write_addr_reg[8]_i_2_n_0\,
      I5 => write_addr(8),
      O => \Window_buffer_write_addr_reg[8]_i_1_n_0\
    );
\Window_buffer_write_addr_reg[8]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => write_addr(6),
      I1 => write_addr(7),
      O => \Window_buffer_write_addr_reg[8]_i_2_n_0\
    );
\Window_buffer_write_addr_reg[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAFFFF00C00000"
    )
        port map (
      I0 => \Window_buffer_write_addr_reg[9]_i_2_n_0\,
      I1 => write_addr(6),
...
\Window_buffer_write_addr_reg[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"CFFFFFFD"
    )
        port map (
      I0 => write_addr(10),
      I1 => \Window_buffer_write_addr_reg[10]_i_6_n_0\,
      I2 => write_addr(7),
      I3 => write_addr(6),
      I4 => write_addr(3),
      O => \Window_buffer_write_addr_reg[9]_i_2_n_0\
    );
\Window_buffer_write_addr_reg[9]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFFFFFFFFFF"
    )
        port map (
...
controller_inst: entity work.finn_design_ConvolutionInputGenerator_rtl_7_0_swg_controller
     port map (
      ...
      \Current_elem_reg[0]\(0) => controller_inst_n_40,
      \Current_elem_reg[14]\(3) => controller_inst_n_33,
      \Current_elem_reg[14]\(2) => controller_inst_n_34,
      \Current_elem_reg[14]\(1) => controller_inst_n_35,
      \Current_elem_reg[14]\(0) => controller_inst_n_36,
      \Current_elem_reg[14]_0\ => \Current_elem[14]_i_5_n_0\,
      \Current_elem_reg[7]\(3) => controller_inst_n_41,
      \Current_elem_reg[7]\(2) => controller_inst_n_42,
      \Current_elem_reg[7]\(1) => controller_inst_n_43,
      \Current_elem_reg[7]\(0) => controller_inst_n_44,
      D(2 downto 0) => p_1_in(14 downto 12),
      DI(3) => controller_inst_n_11,
      DI(2) => controller_inst_n_12,
      DI(1) => controller_inst_n_13,
      DI(0) => controller_inst_n_14,
      Fetching_done_reg => controller_inst_n_32,
      \First_elem_next_window_reg[10]\(2) => controller_inst_n_6,
      \First_elem_next_window_reg[10]\(1) => controller_inst_n_7,
      \First_elem_next_window_reg[10]\(0) => controller_inst_n_8,
      \First_elem_next_window_reg[7]\(1) => controller_inst_n_9,
      \First_elem_next_window_reg[7]\(0) => controller_inst_n_10,
      Newest_buffered_elem_reg(6 downto 0) => Newest_buffered_elem_reg(14 downto 8),
      O(2 downto 0) => data0(14 downto 12),
      Q(8 downto 5) => First_elem_next_window(10 downto 7),
      Q(4 downto 0) => First_elem_next_window(4 downto 0),
      S(3) => controller_inst_n_2,
      S(2) => controller_inst_n_3,
      S(1) => controller_inst_n_4,
      S(0) => controller_inst_n_5,
      \State_reg[2]_0\(0) => controller_inst_n_18,
      \State_reg[2]_1\(0) => controller_inst_n_38,
      \State_reg[2]_2\(0) => controller_inst_n_39,
      \State_reg[2]_3\(2) => controller_inst_n_45,
      \State_reg[2]_3\(1) => controller_inst_n_46,
      \State_reg[2]_3\(0) => controller_inst_n_47,
      \Window_buffer_read_addr_reg1_carry__1\(7) => \Window_buffer_read_addr_reg_reg_n_0_[11]\,
      \Window_buffer_read_addr_reg1_carry__1\(6 downto 1) => read_addr(9 downto 4),
      ...
      \Window_buffer_read_addr_reg_reg[0]\(0) => controller_inst_n_48,
      \Window_buffer_read_addr_reg_reg[11]\(2) => controller_inst_n_15,
      \Window_buffer_read_addr_reg_reg[11]\(1) => controller_inst_n_16,
      \Window_buffer_read_addr_reg_reg[11]\(0) => controller_inst_n_17,
      ...
      \Window_buffer_read_addr_reg_reg[5]\(0) => \Window_buffer_read_addr_reg[5]_i_6_n_0\,
      \Window_buffer_read_addr_reg_reg[5]_0\(0) => Window_buffer_read_addr_reg1_carry_n_4,
      \Window_buffer_read_addr_reg_reg[7]\(3) => controller_inst_n_49,
      \Window_buffer_read_addr_reg_reg[7]\(2) => controller_inst_n_50,
      \Window_buffer_read_addr_reg_reg[7]\(1) => controller_inst_n_51,
      \Window_buffer_read_addr_reg_reg[7]\(0) => controller_inst_n_52,
      \Window_buffer_read_addr_reg_reg[9]\(0) => controller_inst_n_1,
      \Window_buffer_read_addr_reg_reg[9]_0\(0) => controller_inst_n_37,
      \Window_buffer_read_addr_reg_reg[9]_1\(3) => \Window_buffer_read_addr_reg1_carry__0_n_4\,
      \Window_buffer_read_addr_reg_reg[9]_1\(2) => \Window_buffer_read_addr_reg1_carry__0_n_5\,
      \Window_buffer_read_addr_reg_reg[9]_1\(1) => \Window_buffer_read_addr_reg1_carry__0_n_6\,
      \Window_buffer_read_addr_reg_reg[9]_1\(0) => \Window_buffer_read_addr_reg1_carry__0_n_7\,
      addr_incr0 => addr_incr0,
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      \fetch_cmd2_carry__0\(11 downto 1) => Current_elem(14 downto 4),
      \fetch_cmd2_carry__0\(0) => Current_elem(0),
      out_V_TREADY => out_V_TREADY,
      out_V_TREADY_0(9) => controller_inst_n_22,
      out_V_TREADY_0(8) => controller_inst_n_23,
      out_V_TREADY_0(7) => controller_inst_n_24,
      out_V_TREADY_0(6) => controller_inst_n_25,
      out_V_TREADY_0(5) => controller_inst_n_26,
      out_V_TREADY_0(4) => controller_inst_n_27,
      out_V_TREADY_0(3) => controller_inst_n_28,
      out_V_TREADY_0(2) => controller_inst_n_29,
      out_V_TREADY_0(1) => controller_inst_n_30,
      out_V_TREADY_0(0) => controller_inst_n_31
    );
...
\read_cmd2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => window_buffer_inst_n_8,
      DI(2) => window_buffer_inst_n_9,
...
\read_cmd2_inferred__0/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => window_buffer_inst_n_14,
      DI(2) => window_buffer_inst_n_15,
      DI(1) => window_buffer_inst_n_16,
      DI(0) => window_buffer_inst_n_17,
...
\read_cmd3_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(1) => \NLW_read_cmd3_carry__2_CO_UNCONNECTED\(1),
      CO(0) => \read_cmd3_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => Newest_buffered_elem_reg(13),
      O(3 downto 2) => \NLW_read_cmd3_carry__2_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => read_cmd3(14 downto 13),
      S(3 downto 2) => B"01",
      S(1) => window_buffer_inst_n_12,
      S(0) => window_buffer_inst_n_13
    );
...
window_buffer_inst: entity work.finn_design_ConvolutionInputGenerator_rtl_7_0_swg_cyclic_buffer_addressable
     port map (
      CO(0) => \read_cmd2__7\,
      DI(3) => window_buffer_inst_n_8,
      DI(2) => window_buffer_inst_n_9,
      DI(1) => window_buffer_inst_n_10,
      DI(0) => window_buffer_inst_n_11,
      \First_elem_next_window_reg[14]\(3) => window_buffer_inst_n_14,
      \First_elem_next_window_reg[14]\(2) => window_buffer_inst_n_15,
      \First_elem_next_window_reg[14]\(1) => window_buffer_inst_n_16,
      \First_elem_next_window_reg[14]\(0) => window_buffer_inst_n_17,
      \First_elem_next_window_reg[14]_0\(3) => window_buffer_inst_n_18,
      \First_elem_next_window_reg[14]_0\(2) => window_buffer_inst_n_19,
      \First_elem_next_window_reg[14]_0\(1) => window_buffer_inst_n_20,
      \First_elem_next_window_reg[14]_0\(0) => window_buffer_inst_n_21,
      Newest_buffered_elem_reg(14 downto 0) => Newest_buffered_elem_reg(14 downto 0),
      \Newest_buffered_elem_reg[14]\(1) => window_buffer_inst_n_12,
      \Newest_buffered_elem_reg[14]\(0) => window_buffer_inst_n_13,
      \Newest_buffered_elem_reg[14]_0\(0) => read_cmd219_in,
      Newest_buffered_elem_reg_10_sp_1 => window_buffer_inst_n_1,
      Newest_buffered_elem_reg_4_sp_1 => window_buffer_inst_n_3,
      Newest_buffered_elem_reg_9_sp_1 => window_buffer_inst_n_2,
      ...
      Q(6 downto 0) => Current_elem(14 downto 8),
      ...
      out_V_TREADY => out_V_TREADY,
      p_21_in => p_21_in,
      \read_cmd2_inferred__0/i__carry__0\(0) => \read_cmd3_carry__2_n_1\,
      \read_cmd2_inferred__0/i__carry__0_0\(6 downto 0) => First_elem_next_window(14 downto 8),
      read_cmd3(6 downto 0) => read_cmd3(14 downto 8)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7 is
  port (
    out_V_TDATA : out STD_LOGIC_VECTOR ( 2 downto 0 );
    in0_V_TREADY : out STD_LOGIC;
    out_V_TVALID : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7 : entity is "ConvolutionInputGenerator_rtl_7";
end finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7 is
begin
impl: entity work.finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7_impl
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(2 downto 0) => in0_V_TDATA(2 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_ConvolutionInputGenerator_rtl_7_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of finn_design_ConvolutionInputGenerator_rtl_7_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_ConvolutionInputGenerator_rtl_7_0 : entity is "finn_design_ConvolutionInputGenerator_rtl_7_0,ConvolutionInputGenerator_rtl_7,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_ConvolutionInputGenerator_rtl_7_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_ConvolutionInputGenerator_rtl_7_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_ConvolutionInputGenerator_rtl_7_0 : entity is "ConvolutionInputGenerator_rtl_7,Vivado 2022.2";
end finn_design_ConvolutionInputGenerator_rtl_7_0;

architecture STRUCTURE of finn_design_ConvolutionInputGenerator_rtl_7_0 is
...
inst: entity work.finn_design_ConvolutionInputGenerator_rtl_7_0_ConvolutionInputGenerator_rtl_7
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
      in0_V_TDATA(2 downto 0) => in0_V_TDATA(2 downto 0),
