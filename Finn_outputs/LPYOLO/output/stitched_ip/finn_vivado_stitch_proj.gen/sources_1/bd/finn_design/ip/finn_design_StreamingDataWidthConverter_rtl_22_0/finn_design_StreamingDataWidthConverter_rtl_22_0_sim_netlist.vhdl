...
-- Date        : Mon Feb 16 18:42:47 2026
-- Host        : patanjali-slpsk running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/ug_lab/finn/notebooks/pls5/output/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_rtl_22_0/finn_design_StreamingDataWidthConverter_rtl_22_0_sim_netlist.vhdl
-- Design      : finn_design_StreamingDataWidthConverter_rtl_22_0
...
entity finn_design_StreamingDataWidthConverter_rtl_22_0_dwc is
  port (
  ...
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_22_0_dwc : entity is "dwc";
end finn_design_StreamingDataWidthConverter_rtl_22_0_dwc;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_22_0_dwc is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_22_0_dwc_axi is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_22_0_dwc_axi : entity is "dwc_axi";
end finn_design_StreamingDataWidthConverter_rtl_22_0_dwc_axi;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_22_0_dwc_axi is
begin
core: entity work.finn_design_StreamingDataWidthConverter_rtl_22_0_dwc
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_22_0_StreamingDataWidthConverter_rtl_22 is
  port (
    \genUp.ACnt_reg[1]\ : out STD_LOGIC;
    \genUp.BRdy_reg\ : out STD_LOGIC;
    out_V_TDATA : out STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_StreamingDataWidthConverter_rtl_22_0_StreamingDataWidthConverter_rtl_22 : entity is "StreamingDataWidthConverter_rtl_22";
end finn_design_StreamingDataWidthConverter_rtl_22_0_StreamingDataWidthConverter_rtl_22;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_22_0_StreamingDataWidthConverter_rtl_22 is
begin
impl: entity work.finn_design_StreamingDataWidthConverter_rtl_22_0_dwc_axi
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_StreamingDataWidthConverter_rtl_22_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of finn_design_StreamingDataWidthConverter_rtl_22_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_StreamingDataWidthConverter_rtl_22_0 : entity is "finn_design_StreamingDataWidthConverter_rtl_22_0,StreamingDataWidthConverter_rtl_22,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_StreamingDataWidthConverter_rtl_22_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_StreamingDataWidthConverter_rtl_22_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_StreamingDataWidthConverter_rtl_22_0 : entity is "StreamingDataWidthConverter_rtl_22,Vivado 2022.2";
end finn_design_StreamingDataWidthConverter_rtl_22_0;

architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_22_0 is
...
inst: entity work.finn_design_StreamingDataWidthConverter_rtl_22_0_StreamingDataWidthConverter_rtl_22
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
